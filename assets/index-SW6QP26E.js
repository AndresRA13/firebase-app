 ...
 *
 * @license MIT
 */function Oa(){return Oa=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Oa.apply(this,arguments)}const Sg=M.createContext(null),WL=M.createContext(null),Gr=M.createContext(null),Ef=M.createContext(null),Qr=M.createContext({outlet:null,matches:[],isDataRoute:!1}),YI=M.createContext(null);function KL(t,e){let{relative:n}=e===void 0?{}:e;Xo()||Oe(!1);let{basename:r,navigator:i}=M.useContext(Gr),{hash:o,pathname:s,search:a}=JI(t,{relative:n}),l=s;return r!=="/"&&(l=s==="/"?r:Or([r,s])),i.createHref({pathname:l,search:a,hash:o})}function Xo(){return M.useContext(Ef)!=null}function ll(){return Xo()||Oe(!1),M.useContext(Ef).location}function XI(t){M.useContext(Gr).static||M.useLayoutEffect(t)}function If(){let{isDataRoute:t}=M.useContext(Qr);return t?oM():qL()}function qL(){Xo()||Oe(!1);let t=M.useContext(Sg),{basename:e,future:n,navigator:r}=M.useContext(Gr),{matches:i}=M.useContext(Qr),{pathname:o}=ll(),s=JSON.stringify(Ig(i,n.v7_relativeSplatPath)),a=M.useRef(!1);return XI(()=>{a.current=!0}),M.useCallback(function(f,p){if(p===void 0&&(p={}),!a.current)return;if(typeof f=="number"){r.go(f);return}let m=Tg(f,JSON.parse(s),o,p.relative==="path");t==null&&e!=="/"&&(m.pathname=m.pathname==="/"?e:Or([e,m.pathname])),(p.replace?r.replace:r.push)(m,p.state,p)},[e,r,s,o,t])}function JI(t,e){let{relative:n}=e===void 0?{}:e,{future:r}=M.useContext(Gr),{matches:i}=M.useContext(Qr),{pathname:o}=ll(),s=JSON.stringify(Ig(i,r.v7_relativeSplatPath));return M.useMemo(()=>Tg(t,JSON.parse(s),o,n==="path"),[t,s,o,n])}function GL(t,e){return QL(t,e)}function QL(t,e,n,r){Xo()||Oe(!1);let{navigator:i}=M.useContext(Gr),{matches:o}=M.useContext(Qr),s=o[o.length-1],a=s?s.params:{};s&&s.pathname;let l=s?s.pathnameBase:"/";s&&s.route;let f=ll(),p;if(e){var m;let C=typeof e=="string"?Ui(e):e;l==="/"||(m=C.pathname)!=null&&m.startsWith(l)||Oe(!1),p=C}else p=f;let g=p.pathname||"/",E=g;if(l!=="/"){let C=l.replace(/^\//,"").split("/");E="/"+g.replace(/^\//,"").split("/").slice(C.length).join("/")}let I=TL(t,{pathname:E}),T=eM(I&&I.map(C=>Object.assign({},C,{params:Object.assign({},a,C.params),pathname:Or([l,i.encodeLocation?i.encodeLocation(C.pathname).pathname:C.pathname]),pathnameBase:C.pathnameBase==="/"?l:Or([l,i.encodeLocation?i.encodeLocation(C.pathnameBase).pathname:C.pathnameBase])})),o,n,r);return e&&T?M.createElement(Ef.Provider,{value:{location:Oa({pathname:"/",search:"",hash:"",state:null,key:"default"},p),navigationType:yr.Pop}},T):T}function YL(){let t=iM(),e=zL(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return M.createElement(M.Fragment,null,M.createElement("h2",null,"Unexpected Application Error!"),M.createElement("h3",{style:{fontStyle:"italic"}},e),n?M.createElement("pre",{style:i},n):null,null)}const XL=M.createElement(YL,null);class JL extends M.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?M.createElement(Qr.Provider,{value:this.props.routeContext},M.createElement(YI.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function ZL(t){let{routeContext:e,match:n,children:r}=t,i=M.useContext(Sg);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),M.createElement(Qr.Provider,{value:e},r)}function eM(t,e,n,r){var i;if(e===void 0&&(e=[]),n===void 0&&(n=null),r===void 0&&(r=null),t==null){var o;if((o=n)!=null&&o.errors)t=n.matches;else return null}let s=t,a=(i=n)==null?void 0:i.errors;if(a!=null){let p=s.findIndex(m=>m.route.id&&(a==null?void 0:a[m.route.id]));p>=0||Oe(!1),s=s.slice(0,Math.min(s.length,p+1))}let l=!1,f=-1;if(n&&r&&r.v7_partialHydration)for(let p=0;p<s.length;p++){let m=s[p];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(f=p),m.route.id){let{loaderData:g,errors:E}=n,I=m.route.loader&&g[m.route.id]===void 0&&(!E||E[m.route.id]===void 0);if(m.route.lazy||I){l=!0,f>=0?s=s.slice(0,f+1):s=[s[0]];break}}}return s.reduceRight((p,m,g)=>{let E,I=!1,T=null,C=null;n&&(E=a&&m.route.id?a[m.route.id]:void 0,T=m.route.errorElement||XL,l&&(f<0&&g===0?(sM("route-fallback",!1),I=!0,C=null):f===g&&(I=!0,C=m.route.hydrateFallbackElement||null)));let w=e.concat(s.slice(0,g+1)),v=()=>{let _;return E?_=T:I?_=C:m.route.Component?_=M.createElement(m.route.Component,null):m.route.element?_=m.route.element:_=p,M.createElement(ZL,{match:m,routeContext:{outlet:p,matches:w,isDataRoute:n!=null},children:_})};return n&&(m.route.ErrorBoundary||m.route.errorElement||g===0)?M.createElement(JL,{location:n.location,revalidation:n.revalidation,component:T,error:E,children:v(),routeContext:{outlet:null,matches:w,isDataRoute:!0}}):v()},null)}var ZI=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(ZI||{}),Ec=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(Ec||{});function tM(t){let e=M.useContext(Sg);return e||Oe(!1),e}function nM(t){let e=M.useContext(WL);return e||Oe(!1),e}function rM(t){let e=M.useContext(Qr);return e||Oe(!1),e}function eT(t){let e=rM(),n=e.matches[e.matches.length-1];return n.route.id||Oe(!1),n.route.id}function iM(){var t;let e=M.useContext(YI),n=nM(Ec.UseRouteError),r=eT(Ec.UseRouteError);return e!==void 0?e:(t=n.errors)==null?void 0:t[r]}function oM(){let{router:t}=tM(ZI.UseNavigateStable),e=eT(Ec.UseNavigateStable),n=M.useRef(!1);return XI(()=>{n.current=!0}),M.useCallback(function(i,o){o===void 0&&(o={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,Oa({fromRouteId:e},o)))},[t,e])}const a0={};function sM(t,e,n){!e&&!a0[t]&&(a0[t]=!0)}function Vd(t){let{to:e,replace:n,state:r,relative:i}=t;Xo()||Oe(!1);let{future:o,static:s}=M.useContext(Gr),{matches:a}=M.useContext(Qr),{pathname:l}=ll(),f=If(),p=Tg(e,Ig(a,o.v7_relativeSplatPath),l,i==="path"),m=JSON.stringify(p);return M.useEffect(()=>f(JSON.parse(m),{replace:n,state:r,relative:i}),[f,m,i,n,r]),null}function xs(t){Oe(!1)}function aM(t){let{basename:e="/",children:n=null,location:r,navigationType:i=yr.Pop,navigator:o,static:s=!1,future:a}=t;Xo()&&Oe(!1);let l=e.replace(/^\/*/,"/"),f=M.useMemo(()=>({basename:l,navigator:o,static:s,future:Oa({v7_relativeSplatPath:!1},a)}),[l,a,o,s]);typeof r=="string"&&(r=Ui(r));let{pathname:p="/",search:m="",hash:g="",state:E=null,key:I="default"}=r,T=M.useMemo(()=>{let C=Eg(p,l);return C==null?null:{location:{pathname:C,search:m,hash:g,state:E,key:I},navigationType:i}},[l,p,m,g,E,I,i]);return T==null?null:M.createElement(Gr.Provider,{value:f},M.createElement(Ef.Provider,{children:n,value:T}))}function lM(t){let{children:e,location:n}=t;return GL(fp(e),n)}new Promise(()=>{});function fp(t,e){e===void 0&&(e=[]);let n=[];return M.Children.forEach(t,(r,i)=>{if(!M.isValidElement(r))return;let o=[...e,i];if(r.type===M.Fragment){n.push.apply(n,fp(r.props.children,o));return}r.type!==xs&&Oe(!1),!r.props.index||!r.props.children||Oe(!1);let s={id:r.props.id||o.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(s.children=fp(r.props.children,o)),n.push(s)}),n}/**
